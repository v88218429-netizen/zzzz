...
- Validation now includes semantic tests for WB public-price size selection/calibration and K2 fail-closed duplicate/drop protection, not only syntax checks.
